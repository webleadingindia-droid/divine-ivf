        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          <div className="relative rounded-xl overflow-hidden shadow-md aspect-[4/3]">
            <Image
              ...
              alt="High-magnification microscope used for ICSI procedure at Divine IVF Noida"
              fill
          ...
          <div className="relative rounded-xl overflow-hidden shadow-md aspect-[4/3]">
            <Image
              ...
              alt="Hormonal assessment and preparation for IVF with ICSI at Divine IVF Clinic Noida"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
