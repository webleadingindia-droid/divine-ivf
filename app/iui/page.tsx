        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          <div className="relative rounded-xl overflow-hidden shadow-md aspect-[4/3]">
            <Image
              ...
              alt="Blood test and hormonal assessment before IUI treatment at Divine IVF Noida"
              fill
          ...
          <div className="relative rounded-xl overflow-hidden shadow-md aspect-[4/3]">
            <Image
              ...
              alt="Ultrasound monitoring during IUI cycle at Divine IVF Clinic Sector 76 Noida"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
