      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          <div className="relative rounded-xl overflow-hidden shadow-md aspect-[4/3]">
            <Image
              src="https://images.unsplash.com/photo-1622902046580-2b47f47f5471?q=80&w=1200&auto=format&fit=crop"
              alt="Sperm retrieval procedure at Divine IVF Noida"
              fill
          ...
          <div className="relative rounded-xl overflow-hidden shadow-md aspect-[4/3]">
            <Image
              ...
              alt="Hormonal assessment before sperm retrieval at Divine IVF Clinic Noida"
              fill
              className="object-cover"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
